...
$old_checkout_timestamp = strtotime($row['TimeCardCheckIn']);
...
echo '<input type="hidden" name="TimeCardName" value="'.$name.'" />
<input type="hidden" name="submit" value="Submit" />
<br />
<br />';
echo '<button class="btn waves-effect waves-light center green" type="submit" >Confirm Clock-In
