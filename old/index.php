...
<div style="margin: auto; width: 50%; padding: 10px;">
  <div class="row center">
    ...
    <div class="card white lighten-1">
      ...
      <a href="timecard.php" class="waves-effect green waves-light btn-large"><i class="material-icons left">timer</i>Time Card</a>
   ...
   <br /><br />
      ...
      <div class="card white lighten-1">
        ...
        <a href="location.php" class="waves-effect waves-light btn-large">Tray/Shelf Location</a> <a href="crosscheck.php" class="waves-effect waves-light btn-large">Cross Check</a> <br />
        <br />
      </div>
    </div>
  </div>
