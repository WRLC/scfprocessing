  ...
  <div class="row">
     <div class="col s12 push-m3 m6">
      <div class="card white lighten-1" style="margin-top:20px;">
        <div class="card-content blue-text"> <span class="card-title blue lighten-5 bold center">Add Internal Note 1: 
         <?php echo $_SESSION['user_id']; ?></span><p class="center">Add Internal Note 1 field with tray barcode</p>
          <div class="row">
            <style>
#hideMe {
