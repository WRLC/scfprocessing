...
<thead>
  <tr>
    ...
    <th class="blue-grey-text">Hours (15 minute)</th>
  </tr>
</thead>
<tbody>
  <?php 
...
//// Final display of row ////
	echo '<tr><td>'.$CheckedInDate.'</td><td>';
...
echo '<h4 class="center" style="margin-top:-10px;">Total Hours: '.$hours3.':'.$mins3.'</h4>';
