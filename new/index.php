  ...
  <div class="row center">
   ...
   <br /><br />
      ...
      <div class="card white lighten-1">
        ...
        <a href="processing.php" class="waves-effect waves-light btn-large">Tray/Shelf Location</a> <a href="crosscheck.php" class="waves-effect waves-light btn-large">Cross Check 
