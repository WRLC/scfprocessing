...
<span class="card-title center">Billing Counts Report</span>
<?php
if(isset($beginurl) AND isset($endurl)) {
...
<table class="striped">
<thead>
<tr><th class="blue-grey white-text center">Library</th><th class="blue-grey white-text center">Volumes</th><th class="blue-grey white-text center">Oversized Books</th><th class="blue-grey white-text center">Boxes</th><th class="blue-grey white-text center">Clamshells</th><th class="blue-grey white-text center">Flat Boxes</th><th class="blue-grey white-text center">Long Boxes</th></tr>
</thead>
<tbody>
<?php
...
///// Volumes without special counts ///////
	$sqlsum = "SELECT plibrary,SUM(cccount) FROM ProcessingAll WHERE (pcode <>'BX' AND pcode <> 'RB' AND pcode <> 'XX' AND pcode <> 'CB' AND pcode <> 'GB' AND pcode <> 'LB') AND (plibrary = '$library') $daterange";
